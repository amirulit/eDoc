...
Upload Not Required
    ...
    */
    ...
    public static String SaveException(Int32 dd_id, Int32 doc_sl, String status, String details)
    {
        //Object[] details = null;
        String msg = "";
        ...
        command.CommandText = "usp_Save_Exceptions";
        command.Connection = connection;

        command.Parameters.Add(new SqlParameter("@drawdown_id", dd_id));
        command.Parameters.Add(new SqlParameter("@doc_sl", doc_sl));
