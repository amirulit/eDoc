<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Copy of DocumentUpload_V9.aspx.cs"
    Inherits="DocumentUpload_V9" Debug="true" %>
    ...
    <div style="margin: 10px; padding: 10px;">
        ...
        <div id="accordion" style="width: auto;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="radio" class="rdo" name="opt_req_<%=TableData.Rows[data]["SL"]%>" data-id="<%=TableData.Rows[data]["SL"]%>"
                                        value="Y" <%=TableData.Rows[data]["Required"].ToString()=="Yes"?"checked":""%> />Yes
                                    <input type="radio" class="rdo" name="opt_req_<%=TableData.Rows[data]["SL"]%>" data-id="<%=TableData.Rows[data]["SL"]%>"
                                        value="N" />No
                                </td>
                                <td>
         ...
         <br />
            ...
            <table>
            <tr><td>SL</td><td>Exception</td><td>Reason</td><td>Comply Date</td></tr>
            ...
            Any Other Document : 
            <table>
            <tr><td>SL</td><td>Document Details</td><td>Status</td><td>Reason/Explanation</td><td>Action</td></tr>

            <tr><td>SL</td><td><input   type="text"/></td><td><select><option>Not Obtained</option><option>Partially Obtained</option></select></td><td><input type="text" /></td><td><input type="button" value="Save" /></td></tr>
            ...
            <br />
             ...
             <table>
            <tr><td>SL</td><td>Question</td><td>Reply</td><td>If no reasons</td><td>Action</td></tr>

            <tr><td>1</td><td>Documents obtained are executed/signed by appropriate person in presence of HoB or Authorized Branch Officials, duly filled in, properly stamped, witnessed by Authorized Signatory
</td><td>
    <input id="Radio1" type="radio" /><input id="Radio2" type="radio" />
</td><td><input type="text" /></td><td><input type="button" value="Save" /></td></tr>
