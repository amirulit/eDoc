<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ProfileCreate_V2.aspx.cs" Inherits="ProfileCreate_V2"  Debug="true" %>
        ...
        $(document).ready(function () {
            ...
            function getDetails(cus_type, cus_code) {
                ...
                $.ajax({
                    ...
                    url: "ProfileCreate_V2.aspx/Get_CustomerInfo",
                    ...
                    success: function (data) {
                        ...
                        var sts = data.d.Obj.StatusCode;
                        var txt = data.d.Obj.StatusText; ; //  JSON.parse(sts)

                        //alert(sts + '-' + txt);

                        //$("#teacherDetails").modal("show");



                        $('#CorpMgmtInfo tbody').remove();
                        //console.log(data.d);
                        for (var i = 0; i < data.d.Corp.length; i++) {
                            $("#CorpMgmtInfo").append(
                                "<tr><td>" + cus_code + "</td><td>" + data.d.Corp[i].corpMgmtCusId + "</td><td>" + data.d.Corp[i].corpMgmtPosition + "</td>" +

                                "<td>" + "<input type='button' class='btn btn-primary editButton' data-id='" + data.d.Corp[i].corpMgmtCusId + "' data-toggle='modal' data-target='#myModal' name='submitButton' id='btnEdit' value='Edit' />" + "</td>" +
                                "<td><input type='button' class='btn btn-primary deleteButton' data-id='" + data.d.Corp[i].corpMgmtCusId + "' name='submitButton' id='btnDelete' value='Delete'/> </td></tr>");
                        }
                        ...
                        if (sts == "0000") {
                            ...
                            if (cus_type == "INDV") {
                                ...
                                $("#txtName").val(data.d.Obj.shortName);
                                $("#txtFName").val(data.d.Obj.ltCusFathername);
                                $("#txtMName").val(data.d.Obj.ltCusMothername);
                                $("#txtPhoneNumber").val(data.d.Obj.smsNumber);
                                $("#txtGender").val(data.d.Obj.gender);
                                $("#txtTIN").val(data.d.Obj.tinId);
                                $("#txtLegalID").val(data.d.Obj.legalId);
                                $("#txtLegalIDDocName").val(data.d.Obj.legalDocumentName);
                                $("#txtPreAddr").val(data.d.Obj.presentAddress);
                                $("#txtPerAddr").val(data.d.Obj.ltCusPermanentAddress);
                            ...
                            if (cus_type == "PROP") {
                                ...
                                $("#txtNameProp").val(data.d.Obj.shortName);

                                $("#txtPhoneNumberProp").val(data.d.Obj.smsNumber);

                                $("#txtTINProp").val(data.d.Obj.tinId);
                                $("#txtLegalIDProp").val(data.d.Obj.legalId);
                                $("#txtLegalIDDocNameProp").val(data.d.Obj.legalDocumentName);
                                $("#txtPreAddrProp").val(data.d.Obj.presentAddress);
                                $("#txtPerAddrProp").val(data.d.Obj.ltCusPermanentAddress);
                            }
                            ...
                            if (cus_type == "PART") {
                                ...
                                $("#txtNamePart").val(data.d.Obj.shortName);

                                $("#txtPhoneNumberPart").val(data.d.Obj.smsNumber);

                                $("#txtTINPart").val(data.d.Obj.tinId);
                                $("#txtLegalIDPart").val(data.d.Obj.legalId);
                                $("#txtLegalIDDocNamePart").val(data.d.Obj.legalDocumentName);
                                $("#txtPreAddrPart").val(data.d.Obj.presentAddress);
                                $("#txtPerAddrPart").val(data.d.Obj.ltCusPermanentAddress);
                            ...
                            if (cus_type == "COMP") {
                                ...
                                $("#txtNameCom").val(data.d.Obj.shortName);

                                $("#txtPhoneNumberCom").val(data.d.Obj.smsNumber);

                                $("#txtTINCom").val(data.d.Obj.tinId);
                                $("#txtLegalIDCom").val(data.d.Obj.legalId);
                                $("#txtLegalIDDocNameCom").val(data.d.Obj.legalDocumentName);
                                $("#txtPreAddrCom").val(data.d.Obj.presentAddress);
                                $("#txtPerAddrCom").val(data.d.Obj.ltCusPermanentAddress);
                            ...
                            if (cus_type == "JV") {
                                ...
                                $("#txtNameJV").val(data.d.Obj.shortName);

                                $("#txtPhoneNumberJV").val(data.d.Obj.smsNumber);

                                $("#txtTINJV").val(data.d.Obj.tinId);
                                $("#txtLegalIDJV").val(data.d.Obj.legalId);
                                $("#txtLegalIDDocNameJV").val(data.d.Obj.legalDocumentName);
                                $("#txtPreAddrJV").val(data.d.Obj.presentAddress);
                                $("#txtPerAddrJV").val(data.d.Obj.ltCusPermanentAddress);
                            }
                        }
...
<option  value="JV">Joint Venture</option>
                            ...
                            <hr />
                            <table class="table table-bordered table-striped" id="divCustomer" style=" display:block;">
                    				<tbody>
                      					<tr>
                           ...
                           <table class="table table-bordered table-striped" id="divCusIndvInfo"  style="display:none;">
                                  ...
                                  <table class="table table-bordered table-striped" id="divCusComInfo" style="display:none;">
                    				<tbody>
                                        ...
                                        <tr>
                                        <td colspan="2">
                                         <table id="CorpMgmtInfo">
                            
                            <thead>
                            <tr><th>Corp Cust ID</th><th>Corp Mgmt Cus Id</th><th>Corp Mgmt Cus Id</th><th></th><th></th></tr>
