<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentUpload_V5.aspx.cs"
    Inherits="DocumentUpload_V5" Debug="true" %>
                        ...
                        doc_id = Convert.ToInt32(TableData.Rows[data]["SL"]);
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="radio"  class="rdo" name="opt_req_<%=TableData.Rows[data]["SL"]%>" data-id="<%=TableData.Rows[data]["SL"]%>" value="Y"   <%=TableData.Rows[data]["Required"].ToString()=="Yes"?"checked":""%> />Yes
                                    <input type="radio"  class="rdo" name="opt_req_<%=TableData.Rows[data]["SL"]%>" data-id="<%=TableData.Rows[data]["SL"]%>" value="N" />No
                                </td>
                                <td>
