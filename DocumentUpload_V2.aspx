<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentUpload_V2.aspx.cs"
    Inherits="DocumentUpload_V2" Debug="true" %>
    ...
    <div style="margin: 10px;">
        ...
        <div id="tabs" style="width: 100%;">
            ...
            <div id="tabs-<%=i %>">
                ...
                <input type="button" class="BulkUpload" value="Upload" data-count="<%=TableData.Rows.Count %>"
                    div-name="<%=DocType[i]%>" />
